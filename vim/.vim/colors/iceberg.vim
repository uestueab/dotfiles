...
" Custom colors
" Helpful link: http://bytefluent.com/vivify/
" pinkish: #d8456f
...
if &background == 'light'
  ...
  hi Pmenu ctermbg=251 ctermfg=237 guibg=#0a0b11 guifg=#33374c
  ...
  hi Todo ctermbg=254 ctermfg=64 guibg=#bd9800 guifg=#000000
  ...
  hi MoreMsg ctermfg=150 guifg=#d8456f
  hi Operator ctermfg=110 guifg=#84a0c6
  hi Pmenu ctermbg=236 ctermfg=251 guibg=#0a0b11 guifg=#8389a3
  hi PmenuSbar ctermbg=236 ctermfg=NONE guibg=#3d425b guifg=NONE
  hi PmenuSel ctermbg=240 ctermfg=255 guibg=#5b6389 guifg=#000000
  hi PmenuThumb ctermbg=251 ctermfg=NONE guibg=#c6c8d1 guifg=NONE
  hi PreProc ctermfg=150 guifg=#d8456f
  hi Question ctermfg=150 guifg=#d8456f
  ...
  hi Special ctermfg=150 guifg=#d8456f
  ...
  hi Todo ctermbg=234 ctermfg=150 guibg=#bd9800 guifg=#000000
  ...
  hi diffAdded ctermfg=150 guifg=#d8456f
  ...
  hi EasyMotionTarget ctermfg=150 guifg=#d8456f
  hi EasyMotionTarget2First ctermfg=216 guifg=#e2a478
  hi EasyMotionTarget2Second ctermfg=216 guifg=#e2a478
  hi GitGutterAdd ctermbg=235 ctermfg=150 guibg=#1e2132 guifg=#d8456f
  ...
  if has('nvim')
    ...
    let g:terminal_ansi_colors = ['#1e2132', '#e27878', '#d8456f', '#e2a478', '#84a0c6', '#a093c7', '#89b8c2', '#c6c8d1', '#6b7089', '#e98989', '#c0ca8e', '#e9b189', '#91acd1', '#ada0d3', '#95c4ce', '#d2d4de']
  endif
endif
